...
#[cfg(feature = "bevy_wgpu")]
use shocovox_rs::{
    octree::{MIPResamplingMethods, Octree, V3c, V3cf32},
...
fn setup(mut commands: Commands, images: ResMut<Assets<Image>>) {
    ...
    if false {
        ...
        tree = Octree::new(64, 32)
            ...
            .load_vox_file_into_new_tree("assets/models/minecraft.vox")
            .expect("Expected vox file load to work, just fukkn rework this mate");
